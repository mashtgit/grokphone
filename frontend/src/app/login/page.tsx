    ...
    <section className="flex min-h-[80dvh] items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm">
        ...
        <p className="mt-1 text-sm text-text-muted">
          Welcome back. Sign in to your VoxHub account.
        </p>
        ...
        <div className="mt-6">
          ...
          <button
            ...
            className="mt-4 flex w-full items-center justify-center gap-2 rounded-lg border border-border bg-surface px-4 py-2.5 text-sm font-medium text-text transition-colors hover:bg-surface-alt"
          >
